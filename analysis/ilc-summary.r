...
# Plot
dpi <- 300
png("paper/figures/ilc-map.png", width=3*dpi, height=1.26*dpi, pointsize=20)
data <- ilc_by_country
id <- "gwcode"
x  <- "ilcs"
...
ggsave(plot=p, file="paper/figures/ilc-by-year.png", width=7, height=2)
